...
**[InfoLABot](/InfoLABot/)** — внушительный набор функционала и большая база данных. Отличается от других ботов тем, что, помимо стандартных функций поиска почты, телефона, автомобиля, ФИО и IP, также осуществляет поиск по документам. Новым пользователям предоставляется возможность заработать запросы.
